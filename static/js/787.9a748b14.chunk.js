"use strict";
(self.webpackChunknewsmonkey = self.webpackChunknewsmonkey || []).push([
  [787],
  {
    787: function (e, n, t) {
      t.r(n),
      ...
      var i,
        ...
        L = function (e, n) {
          i ||
            ((i = n), (r = e), (a = new Date()), k(removeEventListener), S());
        },
        S = function () {
          if (r >= 0 && r < a - w) {
            var e = {
        ...
        P = function (e, n) {
          ...
          if (o) {
            ...
            var v = function () {
              C[r.id] ||
                (o.takeRecords().map(a), o.disconnect(), (C[r.id] = !0), t(!0));
            };
...
//# sourceMappingURL=787.9a748b14.chunk.js.map
